...
public class App 
{
    public static void main(String[] args) throws IOException {
        ...
        f.getContentPane().add(new JButton(new AbstractAction("start new from test-pipeline.xml") {

            public void actionPerformed(ActionEvent e) {
                final Pipeline p = new Pipeline(source);
                p.addPrefix("cv", CVTools.class.getPackage().getName() + ".CV");
                p.addPrefix("o", OmiscidTools.class.getPackage().getName() + ".Omiscid");
                FileInputStream fileInputStream = null;
                try {
                    fileInputStream = new FileInputStream("test-pipeline.xml");
                    p.readFromXML(fileInputStream);
                } catch (Exception ex) {
                ...
                but.setAction(new AbstractAction("remove") {
                    public void actionPerformed(ActionEvent e) {
                        p.stop();
