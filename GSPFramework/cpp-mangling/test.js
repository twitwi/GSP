...
test.assertDemangle(dem, "_Z7func013PiiPifPf", Array(p(t.INT), t.INT, p(t.INT), t.FLOAT, p(t.FLOAT)));
test.assertDemangle(dem, "_Z7func013P3AAAS_", Array(VOID_POINTER, VOID_POINTER));
test.assertDemangle(dem, "_Z7func013PPPPcS1_S0_S_c", Array(p(p(p(t.CHAR_POINTER))), p(p(t.CHAR_POINTER)), p(t.CHAR_POINTER), t.CHAR));
